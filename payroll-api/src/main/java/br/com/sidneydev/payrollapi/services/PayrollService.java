package br.com.sidneydev.payrollapi.services;

import br.com.sidneydev.payrollapi.domain.Payroll;
import br.com.sidneydev.payrollapi.feingClients.UserFeing;
import br.com.sidneydev.payrollapi.services.exceptions.ObjectNotFoundException;
...
public class PayrollService {
    ...
    public Payroll getPayment(Long workerId, Payroll payroll) {
        ...
        try {
            var user = feing.findById(workerId).getBody();
